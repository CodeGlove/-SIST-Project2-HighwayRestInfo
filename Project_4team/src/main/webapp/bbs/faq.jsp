  ...
  <div class="notice-container">
    ...
    <c:if test="${not empty sessionScope.loginUser and sessionScope.loginUser.authority
      ...
      <div class="write-btn-container">
        <button type="button" class="write-btn"
                onclick="javascript:location.href='Controller?type=write&category=Faq&returnTo=faq'">
          글쓰기
        </button>
      </div>
    </c:if>
          ...
          <c:forEach items="${ar}" var="vo" varStatus="vs">
            <div class="notice-item">
              <div class="notice-title-wrap">
                ...
                <a href="Controller?type=view&PostNum=${vo.postNum}&cPage=${p.nowPage}&returnTo=faq" class="notice-title">
                    ${vo.subject}
                </a>
              </div>
    ...
    <div class="pagination-container">
      <ol class="pagination">
        ...
        <c:if test="${p.startPage >= p.pagePerBlock}">
          <li><a href="Controller?type=faq&cPage=${p.nowPage-p.pagePerBlock}">&lt;</a></li>
        </c:if>
        ...
        <c:forEach begin="${p.startPage}" end="${p.endPage}" var="pageNum">
          ...
          <c:if test="${p.nowPage != pageNum}">
            <li><a href="Controller?type=faq&cPage=${pageNum}">${pageNum}</a></li>
          </c:if>
        </c:forEach>
