    ...
    <div class="nav-container">
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="${pageContext.request.contextPath}/Controller?type=notice" class="btn btn-notice">공지사항</a></li>
                <li><a href="#">고객센터</a></li>
        ...
        <div class="auth-buttons">
            ...
            <c:if test="${empty sessionScope.loginUser}">
                <a href="${pageContext.request.contextPath}/Controller?type=login" class="btn btn-login">로그인</a>
                <a href="${pageContext.request.contextPath}/Controller?type=register" class="btn btn-register">회원가입</a>
            </c:if>

            <%--***** 로그인된 경우 --%>
            <c:if test="${not empty sessionScope.loginUser}">
                <a href="${pageContext.request.contextPath}/Controller?type=logout" class="btn btn-logout">로그아웃</a>
                <a href="${pageContext.request.contextPath}/Controller?type=#" class="btn btn-register">마이페이지</a>
            </c:if>
        </div>
    </div>
</header>
    ...
    <div class="notice-container">
        ...
        <c:if test="${not empty sessionScope.loginUser and sessionScope.loginUser.authority
            ...
            <div class="write-btn-container">
                <button type="button" class="write-btn"
                        onclick="javascript:location.href='${pageContext.request.contextPath}/Controller?type=write'">
                    글쓰기
                </button>
            </div>
        </c:if>
                ...
                <c:otherwise>
                    <c:forEach items="${ar}" var="vo" varStatus="vs">
                        <div class="notice-item">
                            <a href="${pageContext.request.contextPath}/Controller?type=view&PostNum=${vo.postNum}&cPage=${p.nowPage}" class="notice-title">
                                    ${vo.subject}
                            </a>
        ...
        <div class="pagination-container">
            <ol class="pagination">
                ...
                <c:if test="${p.startPage >= p.pagePerBlock}">
                    <li><a href="${pageContext.request.contextPath}/Controller?type=notice&cPage=${p.nowPage-p.pagePerBlock}">&lt;</a></li>
                </c:if>
                ...
                <c:forEach begin="${p.startPage}" end="${p.endPage}" var="pageNum">
                    ...
                    <c:if test="${p.nowPage != pageNum}">
                        <li><a href="${pageContext.request.contextPath}/Controller?type=notice&cPage=${pageNum}">${pageNum}</a></li>
                    </c:if>
                </c:forEach>
...
<script>
    function delPost(postNum, cPage) {
        if (confirm("정말로 이 공지사항을 삭제하시겠습니까?")) {
            ...
            // 삭제 요청
            location.href = "${pageContext.request.contextPath}/Controller?type=del&PostNum=" + postNum + "&cPage=" + cPage;
        }
    }
