...
<head>
    ...
    <script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpKeyId=a3kqiwwu0n&submodules=geocoder"></script>
</head>
<body>
<div class="container">
    <h1>네이버 맵 API 테스트</h1>
    ...
    <div class="warning">
        ⚠️ 실제 API 키를 사용하세요! 현재 예제 키를 사용하고 있습니다.
    </div>
        ...
        if (directionsResult.route && directionsResult.route.traoptimal && directionsResult.route.traoptimal.length > 0) {
            ...
            if (route.section && route.section.length > 0) {
                ...
                for (var i = 0; i < route.section.length; i++) {
                    ...
                    routeInfo += (i + 1) + ". " + section.roadName + "\n";
